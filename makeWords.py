...
def sentencetoPicture(sentence, imdict):
    ...
    result.save("sentence.png")

sentencetoPicture("THIS IS A REALLY LONG SENTENCE THE RECOGNITION MACHINE WILL HAVE TO PUT ITS BACK COMPLTELY INTO IT TO BE ABLE TO GET IT RIGHT", imdict)
